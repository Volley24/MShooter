...
public class MachineGun extends Gun {
	...
	public MachineGun(String username) {
		//int reloadTime, int magazineSize, double rateOfFire, double speed, double range, double spread, int damage
		super(username, null, Sprite.bulletSprite, Sprite.machineGunDrop, "Machine Gun",/*Reload Time: */5*60
				,/*Mag size:*/100,/*ROF:*/4,/*Speed:*/8,/*Spread:*/5,/*Range:*/200,/*Damage:*/10);
	...
	public void reload() {
		if (!isReloading) {
			if (this.ammoLoaded < magazineSize) {
				isReloading = true;
			}
		}
